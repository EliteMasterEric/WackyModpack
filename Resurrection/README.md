...
- [General Improvements](https://thunderstore.io/c/lethal-company/p/ShaosilGaming/GeneralImprovements/): A bunch of tweaks
...
### Visuals/HUD
- [Chameleon](https://thunderstore.io/c/lethal-company/p/ButteryStancakes/Chameleon/): Aesthetic fixes for moon environments.
...
- [NicheTweaks](https://thunderstore.io/c/lethal-company/p/mr_hat/NicheTweaks/)
...
- [Universal Radar](https://thunderstore.io/c/lethal-company/p/ScienceBird/Universal_Radar/): Improved radar map graphics, both handcrafted sprites for vanilla moons and auto-generated contour maps for modded moons.
- [LoadingInfo](https://thunderstore.io/c/lethal-company/p/chuxiaaaa/LoadingInfo/): While loading, display the players who haven't finished loading.
- [FinallyCorrectKeys](https://thunderstore.io/c/lethal-company/p/Rminin/FinallyCorrectKeys/): Most UI elements will now display rebound keybinds for prompts.
- [LoadingScreen](https://thunderstore.io/c/lethal-company/p/Bertogim/LoadingScreen/): Display a loading screen with a progress bar while mods are loading, before the menu appears.
- [ScannableCodes](https://thunderstore.io/c/lethal-company/p/Dev1A3/ScannableCodes/): Display the terminal code for a turret or door when scanning it.
...
### Audio
- [UniqueItemSounds](https://thunderstore.io/c/lethal-company/p/debit_card_debit/UniqueItemSounds/): 17 scraps and 3 furnitures now have custom grab and drop sounds.
### Controls
- [CruiserImproved](https://thunderstore.io/c/lethal-company/p/DiggC/CruiserImproved/): Improved interactions with cruisers, such as being able to turn the camera to look behind, adding a scan node to the Cruiser, and a long list of bug fixes.
- [DiFFoz Tweaks](https://thunderstore.io/c/lethal-company/p/DiFFoZ/DiFFoZTweaks/): Flash the windows taskbar icon when the game is loaded and awaiting user input.
...
### Fun
- [HalloweenElevator](https://thunderstore.io/c/lethal-company/p/ButteryStancakes/HalloweenElevator/): Rare chance to play v65 Halloween music in the mineshaft elevator sometimes.
...
- https://thunderstore.io/c/lethal-company/p/AdiBTW/Loadstone/: Functionality is now in base game
- https://thunderstore.io/c/lethal-company/p/JacobG5/ReverbTriggerFix/: Functionality is now in base game
- https://thunderstore.io/c/lethal-company/p/Pooble/LCBetterSaves/: 2 years old and the repo is gone
- https://thunderstore.io/c/lethal-company/p/SillySquad/CentralConfig/: Mod is deprecated
- https://thunderstore.io/c/lethal-company/p/linkoid/DissonanceLagFix/: Functionality is in Dev1A3's LethalFixes
- https://thunderstore.io/c/lethal-company/p/Bobbie/FixRPCLag/: Functionality is in Dev1A3's LethalFixes
...
- https://thunderstore.io/c/lethal-company/p/Drakorle/MoreItems/: Functionality is in LobbyControl
- https://thunderstore.io/c/lethal-company/p/anormaltwig/LateCompany/: Functionality is in LobbyControl
